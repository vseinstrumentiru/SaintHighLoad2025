...
14. [Метрики для метрик: опыт выстраивания SLOs/SLIs для платформы мониторинга - практический пример Discovery (определения SLI/SLO), процесс в деталях](https://devopsconf.io/moscow/2025/abstracts/14014)
